function appendWeather(obj) {
    ...
    house.html("");
    house.append(`<h1 id="cityMain" class="display-4 m-4" >${obj.name}, ${obj.country}</h1><div class="row row-cols-5" id="weatherIn">
            </div>`)
    let inner = $('#weatherIn');
    obj.forecast.forEach(function (day, index) {
        inner.append(`<div class="col" id="day-${index}">
                        <div class="card border border-dark"> 
                            <h5 class="card-header ">${daySort(day.dt_txt)}</h5>
